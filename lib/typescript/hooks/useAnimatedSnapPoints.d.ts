 ...
 */
export declare const useAnimatedSnapPoints: (snapPoints: BottomSheetProps['snapPoints'], containerHeight: SharedValue<number>, contentHeight: SharedValue<number>, handleHeight: SharedValue<number>, enableDynamicSizing: BottomSheetProps['enableDynamicSizing'], maxDynamicContentSize: BottomSheetProps['maxDynamicContentSize']) => [SharedValue<number[]>, SharedValue<number>, SharedValue<boolean>];
