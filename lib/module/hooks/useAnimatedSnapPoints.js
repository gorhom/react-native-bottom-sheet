 ...
 */
export const useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  const normalizedSnapPoints = useDerivedValue(() => {
    ...
    const dynamicSnapPoint = containerHeight.value - Math.min(contentHeight.value + handleHeight.value, maxDynamicContentSize !== undefined ? maxDynamicContentSize : containerHeight.value);
    ...
    return _normalizedSnapPoints;
  }, [containerHeight.value, snapPoints, enableDynamicSizing, handleHeight.value, contentHeight.value, maxDynamicContentSize, dynamicSnapPointIndex]);
