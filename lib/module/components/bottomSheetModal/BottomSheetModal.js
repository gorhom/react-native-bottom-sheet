...
import { SHEET_STATE } from 'src/constants';
const INITIAL_STATE = {
  mount: false,
  data: undefined
};
const BottomSheetModalComponent = /*#__PURE__*/forwardRef(function BottomSheetModal(props, ref) {
  ...
  const handleGetState = useCallback(() => {
    ...
    return ((_bottomSheetRef$curre7 = bottomSheetRef.current) === null || _bottomSheetRef$curre7 === void 0 ? void 0 : _bottomSheetRef$curre7.getState()) || SHEET_STATE.CLOSED;
  }, []); //#endregion
