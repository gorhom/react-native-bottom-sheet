...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheet(props, ref) {
  ...
  const animatedSheetHeight = (0, _reactNativeReanimated.useDerivedValue)(() => animatedContainerHeight.value - animatedHighestSnapPoint.value, [animatedContainerHeight.value, animatedHighestSnapPoint.value]);
  ...
  const animatedSheetState = (0, _reactNativeReanimated.useDerivedValue)(() => {
    ...
    if (animatedPosition.value >= animatedClosedPosition.value) return _constants.SHEET_STATE.CLOSED;
    ...
    if (animatedPosition.value === extendedPosition) return _constants.SHEET_STATE.EXTENDED;
  ...
  const handleGetState = (0, _react.useCallback)(function handleGetState() {
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(() => ({
     ...
     */
    if (_reactNative.Platform.OS === 'android' && keyboardBehavior === _constants.KEYBOARD_BEHAVIOR.interactive && android_keyboardInputMode === _constants.KEYBOARD_INPUT_MODE.adjustResize) {
