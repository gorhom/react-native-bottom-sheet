...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheet(props, ref) {
  ...
  const externalContextVariables = (0, _react.useMemo)(() => ({
    ...
    forceClose: handleForceClose,
    getState: handleGetState
  }), [animatedIndex, animatedPosition, handleSnapToIndex, handleSnapToPosition, handleExpand, handleCollapse, handleClose, handleForceClose, handleGetState]); //#endregion
  //#region styles
