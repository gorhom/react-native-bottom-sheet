...
const BottomSheetModalComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheetModal(props, ref) {
  ...
  const handleGetState = (0, _react.useCallback)(() => {
    ...
    return ((_bottomSheetRef$curre7 = bottomSheetRef.current) === null || _bottomSheetRef$curre7 === void 0 ? void 0 : _bottomSheetRef$curre7.getState()) || _constants2.SHEET_STATE.CLOSED;
  }, []); //#endregion
