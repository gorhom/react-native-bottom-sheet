...
**Bottom Sheet Modal** is a wrapper/decorator on top of the **Bottom Sheet**, it provides all of its functionalities with extra modal presentation functionalities.

With the release of the library, support for stack sheet modals was something planned ahead to provide a native feel and experience to users.
